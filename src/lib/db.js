...
export async function saveAddress(uid, addr) {
  // one address doc per user for now; upgrade to multiple later if needed
...
export async function createBooking(uid, data) {
  const ref = await addDoc(collection(db, "bookings"), {
    ...
    startAt: data.startAt,                 // a Firestore Timestamp
...
// Subscribe to a user’s bookings (live updates)
...
// Update a booking (client-side: reschedule/cancel request; owner confirms/declines later)
