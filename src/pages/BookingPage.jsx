...
export default function BookingPage() {
  ...
  // ✅ FIX: keep hooks at top-level. Prefill user data once if available.
  useEffect(() => {
    ...
    setForm(prev => {
      const next = { ...prev };
      if (!next.name && u.displayName) { next.name = u.displayName; changed = true; }
      if (!next.email && u.email)       { next.email = u.email;       changed = true; }
      if (!next.phone && u.phoneNumber) { next.phone = u.phoneNumber; changed = true; }
