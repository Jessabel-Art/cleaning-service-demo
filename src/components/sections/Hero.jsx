  ...
  return (
    <section className="relative min-h-screen flex items-center justify-center overflow-hidden -mt-20 pt-20">
      ...
      <div className="relative z-10 text-center px-4 max-w-4xl mx-auto">
        <motion.h1 
          className="hero-title text-5xl md:text-7xl font-bold text-white mb-4"
        ...
        <motion.p 
          className="hero-subtitle text-xl md:text-2xl text-white/90 mb-6 font-medium"
        ...
        >
         ...
         <motion.div
          className="flex items-center justify-center gap-4 md:gap-6 text-white/90 text-sm mb-8"
          initial={{ opacity: 0, y: 30 }}
          animate={{ opacity: 1, y: 0 }}
        ...
        >
          ...
          <Button 
            ...
            size="lg"
            variant="outline"
            className="bg-white/20 hover:bg-white/50 border-white text-white backdrop-blur-sm px-8 py-4 text-lg font-semibold rounded-full transition-all duration-300 transform hover:scale-105"
          >
